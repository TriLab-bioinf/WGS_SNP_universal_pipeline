...
jobid3=$(swarm --dependency afterany:$jobid1 --logdir ./00-swarm-log --job-name step3-split --sbatch "--export=CONFIG_FILE=${CONFIG}" -f ./scripts/RNASEQ_SNV-pipeline-step3-split.swarm)
JOB_IDS+=($jobid3)
...
jobid4=$(swarm --dependency afterany:$jobid3 --logdir ./00-swarm-log --job-name step4-cleanBAM --sbatch "--export=CONFIG_FILE=${CONFIG}" -f ./scripts/RNASEQ_SNV-pipeline-step4-cleanBAM.swarm)
JOB_IDS+=($jobid4)
...
jobid5=$(swarm --dependency afterany:$jobid4  --logdir ./00-swarm-log --job-name step5-MarkDuplicates --sbatch "--export=CONFIG_FILE=${CONFIG}" -f ./scripts/RNASEQ_SNV-pipeline-step5-MarkDuplicates.swarm)
JOB_IDS+=($jobid5)
...
jobid6=$(swarm --dependency afterany:$jobid5 --logdir ./00-swarm-log --job-name step6-recalibration --sbatch "--export=CONFIG_FILE=${CONFIG}" -f ./scripts/RNASEQ_SNV-pipeline-step6-recalibration.swarm)
JOB_IDS+=($jobid6)
...
jobid7=$(swarm --dependency afterany:$jobid6 --logdir ./00-swarm-log --job-name step7-split --sbatch "--export=CONFIG_FILE=${CONFIG}" -f ./scripts/RNASEQ_SNV-pipeline-step7-split.swarm)
JOB_IDS+=($jobid7)
...
jobid8=$(swarm --dependency afterany:$jobid7 --logdir ./00-swarm-log --job-name step8-VariantCalling --sbatch "--export=CONFIG_FILE=${CONFIG}" -f ./scripts/RNASEQ_SNV-pipeline-step8-VariantCalling.swarm)
JOB_IDS+=($jobid8)
...
jobid9=$(swarm --dependency afterany:$jobid8 --logdir ./00-swarm-log --job-name step9-filterVariants --sbatch "--export=CONFIG_FILE=${CONFIG}" -f ./scripts/RNASEQ_SNV-pipeline-step9-filterVariants.swarm)
JOB_IDS+=($jobid9)
